<?php
	...
	*/
	...
	function get_user_details($userid) 
	{
      ...
      LEFT JOIN pictures ON " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " = " . DB_AVATARTABLE . "." . DB_AVATARTABLE_USERID . " WHERE " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " = '" . $db->escape_string($userid) . "' ORDER BY pictures.main DESC
		");
