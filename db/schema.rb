...
ActiveRecord::Schema.define(:version => 20130605172958) do
  ...
  create_table "cometchat", :force => true do |t|
    t.integer "from",                         :null => false
    t.integer "to",                           :null => false
    t.text    "message",                      :null => false
    t.integer "sent",      :default => 0,     :null => false
    t.boolean "read",      :default => false, :null => false
    t.boolean "direction", :default => false, :null => false
  end

  add_index "cometchat", ["direction"], :name => "direction"
  add_index "cometchat", ["from"], :name => "from"
  add_index "cometchat", ["read"], :name => "read"
  add_index "cometchat", ["sent"], :name => "sent"
  add_index "cometchat", ["to"], :name => "to"

  create_table "cometchat_announcements", :force => true do |t|
  ...
  add_index "cometchat_announcements", ["time"], :name => "time"
  add_index "cometchat_announcements", ["to", "id"], :name => "to_id"
  add_index "cometchat_announcements", ["to"], :name => "to"

  create_table "cometchat_apehistory", :force => true do |t|
    t.string  "channel", :null => false
    t.text    "message", :null => false
    t.integer "sent",    :null => false
  end

  add_index "cometchat_apehistory", ["channel", "sent"], :name => "channel_sent"
  add_index "cometchat_apehistory", ["channel"], :name => "channel"
  add_index "cometchat_apehistory", ["sent"], :name => "sent"

  create_table "cometchat_block", :force => true do |t|
    t.integer "fromid", :null => false
    t.integer "toid",   :null => false
  end

  add_index "cometchat_block", ["fromid", "toid"], :name => "fromid_toid"
  add_index "cometchat_block", ["fromid"], :name => "fromid"
  add_index "cometchat_block", ["toid"], :name => "toid"

  create_table "cometchat_chatroommessages", :force => true do |t|
    t.integer "userid",     :null => false
    t.integer "chatroomid", :null => false
    t.text    "message",    :null => false
    t.integer "sent",       :null => false
  end

  add_index "cometchat_chatroommessages", ["chatroomid"], :name => "chatroomid"
  add_index "cometchat_chatroommessages", ["sent"], :name => "sent"
  add_index "cometchat_chatroommessages", ["userid"], :name => "userid"

  create_table "cometchat_chatrooms", :force => true do |t|
    t.string  "name",                        :null => false
    t.integer "lastactivity",                :null => false
    t.integer "createdby",                   :null => false
    t.string  "password",                    :null => false
    t.boolean "type",                        :null => false
    t.string  "vidsession",   :limit => 512
  end

  add_index "cometchat_chatrooms", ["createdby"], :name => "createdby"
  add_index "cometchat_chatrooms", ["lastactivity"], :name => "lastactivity"
  add_index "cometchat_chatrooms", ["type"], :name => "type"

  create_table "cometchat_chatrooms_users", :id => false, :force => true do |t|
    t.integer "userid",                      :null => false
    t.integer "chatroomid",                  :null => false
    t.integer "lastactivity",                :null => false
  ...
  add_index "cometchat_chatrooms_users", ["chatroomid", "userid"], :name => "userid_chatroomid"
  add_index "cometchat_chatrooms_users", ["chatroomid"], :name => "chatroomid"
  add_index "cometchat_chatrooms_users", ["lastactivity"], :name => "lastactivity"
  add_index "cometchat_chatrooms_users", ["userid"], :name => "userid"

  create_table "cometchat_games", :primary_key => "userid", :force => true do |t|
    t.integer "score"
    t.integer "games"
    t.text    "recentlist"
    t.text    "highscorelist"
  end

  create_table "cometchat_guests", :force => true do |t|
    t.string  "name",         :null => false
    t.integer "lastactivity", :null => false
  end

  add_index "cometchat_guests", ["lastactivity"], :name => "lastactivity"

  create_table "cometchat_status", :primary_key => "userid", :force => true do |t|
    t.text    "message"
    t.string  "status",     :limit => 9
    t.integer "typingto"
    t.integer "typingtime"
  end

  add_index "cometchat_status", ["typingtime"], :name => "typingtime"
  add_index "cometchat_status", ["typingto"], :name => "typingto"

  create_table "cometchat_videochatsessions", :primary_key => "username", :force => true do |t|
    t.string  "identity",                 :null => false
    t.integer "timestamp", :default => 0
  end

  add_index "cometchat_videochatsessions", ["identity"], :name => "identity"
  add_index "cometchat_videochatsessions", ["timestamp"], :name => "timestamp"
  add_index "cometchat_videochatsessions", ["username"], :name => "username"
