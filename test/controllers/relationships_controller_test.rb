...
describe RelationshipsController do
  ...
  describe "as a matchmaker" do
    ...
    it "should redirect to the celestino become user path (POST #block_hide)" do
      post :block_hide, user_id: @liked_user.id, user_block: { blocked_user: 1 }, user_hide: { hidden_user: 1 }
      assert_response 302
      assert_redirected_to matchmaker_become_user_path
    end
  end
  ...
  describe "as a regular user" do
    ...
    it "should block the interacted user" do
      assert_difference 'UserBlock.count', 1 do
        post :block_hide, user_id: @interacted_user.id, user_block: { blocked_user: 1 }, user_hide: { hidden_user: 0 }
      end
    ...
    it "should hide the interacted user" do
      assert_difference 'UserHide.count', 1 do
        post :block_hide, user_id: @interacted_user.id, user_block: { blocked_user: 0 }, user_hide: { hidden_user: 1 }
      end
